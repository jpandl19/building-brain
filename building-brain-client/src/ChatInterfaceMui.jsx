...
const ChatInterface = (props) => {
        ...
        const fetchInitialMessage = async () => {
            ...
            try {
                ...
                let introHelperMessage = formattedMessage;
                    ...
                    introHelperMessage = `Hello and welcome to BuildingGPT<br /><br /> BuildingGPT makes it simple and easy to troubleshoot and maintain your commercial real estate building. You can do things like:<br />
                    <ul>
    ...
    const sendMessage = async () => {
        ...
        setMessages([...messages, { text: inputMessage, sender: 'user', feedback: null, intro: false }]);
        setInputMessage('');
        ...
        try {
            ...
            const response = await apiClient.post(`/api/chat?platformId=${staticPlatformId}`, { message: inputMessage, max_response_length: responseLengthClean, platformId, });
